...
def login():
    ...
    if form.validate_on_submit():
    	#stores the value in the flask session for subsequent requests
        session['remember_me'] = form.remember_me.data  
		#to autheticate the user through flask-openID, asking nickname and email coz those are the 
		#thing we need for the database
...
def after_login(resp):
    ...
    #first () returns the first result of this Query or None if the result doesnt contain any row.
    #if user email is not found then do the following
    if user is None:
